...
VM_DB_adress = "postgresql+psycopg2:" #add connection in order to work
...
print('Database relations were deleted and new defined')
...
end = datetime.datetime(2015,1,1) #last day not included
